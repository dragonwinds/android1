...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText) findViewById(R.id.main_et_result);//结果
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.main_btnd:
                ...
                editText.setText(input + ((Button)view).getText());//结果就为本身
                break;
            ...
            case R.id.main_btndel:
                if(clear_flag){
                    ...
                    editText.setText(input.substring(0, input.length() - 1));//结果为空
                }
                break;
